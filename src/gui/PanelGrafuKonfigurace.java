...
public class PanelGrafuKonfigurace extends PanelGrafuRodic{
	...
	protected void vlozGrafy(){
		...
		ChartPanel panelGrafu1 = new ChartPanel(this.getHistogramKonfigurace() );
        ChartPanel panelGrafu2 = new ChartPanel(this.getSpojnicovyGrafPocet(this.projekt.getKonfigurace(), Konstanty.POPISY.getProperty("konfiguraceNadpisSpojnicovy")) );
		ChartPanel panelGrafu3 = new ChartPanel(this.getAutorGraf(Konstanty.KONFIGURACE, false) );
